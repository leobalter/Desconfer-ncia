<aside id="sidebar">
    <ul>
        ...
        if (!function_exists('dynamic_sidebar') || !dynamic_sidebar()) : ?>
                ...
                <li><h2><?php _e('Meta', 'minimalism'); ?></h2>
                    <ul>
                        ...
                        <li><a href="http://validator.w3.org/check/referer"
                               title="<?php _e('This page validates as XHTML 1.0 Transitional', 'minimalism'); ?>"><?php _e('Valid <abbr title="eXtensible HyperText Markup Language">XHTML</abbr>', 'minimalism'); ?></a>
                        </li>
                        <li><a href="http://gmpg.org/xfn/"><abbr
                                title="<?php _e('XHTML Friends Network', 'minimalism'); ?>"><?php _e('XFN', 'minimalism'); ?></abbr></a>
                        </li>
                        <li><a href="http://wordpress.org/"
                               title="<?php _e('Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'minimalism'); ?>">WordPress</a>
                        </li>
                        <?php wp_meta(); ?>
                    </ul>
                </li>
            ...
            <?php endif; ?>
        <li><script src="http://connect.facebook.net/pt_BR/all.js#xfbml=1"></script><fb:like-box href="http://www.facebook.com/pages/Desconfer%C3%AAncia/216265685054595" width="190" show_faces="true" stream="false" header="false"></fb:like-box></li>
    </ul>
</aside>
